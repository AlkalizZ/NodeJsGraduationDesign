    ...
    if (o.extend = function (e, t) {
        ...
        it.on("queryDefined", function () {
            ...
            X.mouseenter(N).mouseleave(I), st.PostList = function (e) {
                ...
                uri: "base/recommend",
                mountedAfter: [".detail_main .detail_con .d_img p:last", ".jun4_article .jun4_cententttt", "#content p:last", ".article .content p:last", ".artcontent p:last", '.card_box p>[src="https://cpro.baidustatic.com/cpro/ui/cm.js"]:eq(2)', ".mlrAuto .con_con p:last"],
